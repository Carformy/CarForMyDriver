...
import com.carformy.driver.Utilities.FontsOverride;
...
public class CarForMyDriverApplication extends Application {

    public static final String TAG = CarForMyDriverApplication.class
            .getSimpleName();

    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    private static CarForMyDriverApplication mInstance;
...
//        FontsOverride.setDefaultFont(this, "SANS_SERIF", "ClanPro-Book.otf");
    ...
    public static synchronized CarForMyDriverApplication getInstance() {
        return mInstance;
    }
